...
export const TERMINAL_THEMES: TerminalTheme[] = [
  ...
  },
  {
    id: 'deep-ocean',
    name: 'Deep Ocean',
    preview: ['#011627', '#80a4c2'],
    xterm: {
      background: '#011627',
      foreground: '#d6deeb',
      cursor: '#80a4c2',
      cursorAccent: '#011627',
      selectionBackground: 'rgba(128,164,194,0.2)',
