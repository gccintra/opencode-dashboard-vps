...
export function HarnessFilesModal({ open, harness, onClose }: HarnessFilesModalProps) {
  ...
  return (
    <>
      ...
      >
        <div
          className="mx-4 flex w-full max-w-[560px] flex-col rounded-[14px] border border-white/[0.07] bg-[#111118]"
        ...
        >
          ...
          <div className="flex shrink-0 items-center justify-between border-b border-white/[0.06] px-[20px] py-[14px]">
            ...
            <button
              onClick={onClose}
              className="ml-3 flex size-[30px] shrink-0 items-center justify-center rounded-[6px] text-[#5a626c] hover:bg-[rgba(255,255,255,0.06)] hover:text-[#9aa3ad] transition-colors"
              aria-label="Close"
            >
              <XIcon />
            </button>
          ...
          {/* Tabs */}
          <div className="flex shrink-0 gap-[2px] border-b border-white/[0.06] px-[16px]">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-[8px] border-b border-white/[0.06] px-[16px] py-[10px]">
            <input
              ref={fileInputRef}
              type="file"
              multiple
              ...
              <div className="py-[4px]">
                {flatFiles.length === 0 ? (
                  ...
                  flatFiles.map((f) => (
                    <div
                      key={f.path}
                      className="flex items-center justify-between gap-[12px] border-b border-[rgba(255,255,255,0.04)] px-[16px] py-[10px] last:border-0 hover:bg-white/[0.02]"
                    >
                      <span
