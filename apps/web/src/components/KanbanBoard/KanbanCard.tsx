  ...
  const cardBody = (
    <>
      ...
      <div className="flex flex-wrap items-center gap-[6px]">
        ...
        {task.projectName && (
          <span className="rounded-[5px] border border-white/[0.05] bg-white/[0.02] px-[6px] py-[2px] text-[10px] font-medium text-[#6b7280]">
            {task.projectName}
          </span>
        )}
        {task.sessionId && (
      ...
      {/* Title */}
      <h4 className="text-[13.5px] font-semibold leading-[1.4] text-[#f2f3f5] line-clamp-2">
        {task.title}
      </h4>
      ...
      <div className="flex items-center justify-between pt-[2px]">
        {task.githubIssueUrl ? (
          <a
            ...
            className="inline-flex items-center gap-[4px] text-[11px] font-medium text-[#58a6ff] hover:underline"
          >
