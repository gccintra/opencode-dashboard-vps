              ...
              {candidates.map((t) => (
                <li key={t.id}>
                  ...
                  >
                    ...
                    {t.projectName && (
                      <span className="ml-auto shrink-0 text-[10px] text-[#5a626c]">
                        {t.projectName}
                      </span>
                    )}
                  </button>
              ...
              {grouped.get(t)!.map((l) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-[5px] p-[3px] text-[#5a626c] opacity-0 transition-all group-hover:opacity-100 hover:bg-red-500/10 hover:text-red-400"
                  >
