...
export function IssueBadge({ number }: { number: number }) {
  return (
    <span className="inline-flex items-center gap-[4px] rounded-[4px] border border-white/[0.07] bg-[#24292e] px-[6px] py-[2px] text-[10px] font-medium text-ink">
...
export function ProjectBadge({ name }: { name: string }) {
  return (
    <span className="inline-flex items-center rounded-[4px] border border-white/[0.06] bg-accent/[0.08] px-[6px] py-[1px] text-[10px] font-medium text-accent">
      {name}
    </span>
  );
}
...
export function SessionBadge() {
  return (
    <span
      className="inline-flex items-center gap-[3px] rounded-[4px] border border-accent/25 bg-accent/10 px-[5px] py-[1px] text-[10px] font-medium text-accent"
